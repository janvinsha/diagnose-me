...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex h-screen flex-col p-10 items-center gap-6">
      <MetaTags title="App" />
      <h1 className="text-xl font-semibold">DIAGNOSE ME</h1>
      <div className="flex w-3/5 h-5/6 border-r-2 gap-10 flex-col md:flex-row">
        <div className="flex flex-col bg-[#36152D] h-full w-full rounded-lg p-8 text-white text-sm justify-between">
